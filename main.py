...
def is_resource_sufficient(order_incrediants):
    """Return true when order can ve made, False if ingredients are insufficient """
    for item in order_incrediants:
        if order_incrediants[item] >= resources[item]:
...
def make_coffee(drink_name , order_ingredients):
    """duduct the required ingredients from the resource."""
